data {
  ...
  array[N] real pred1;    // predictor 1
  array[N] real pred2;    // predictor 2
...
parameters {
  ...
  vector[10] beta1[Nc]; // slopes for probabilities of different strategies
  vector[10] beta2[Nc]; // slopes for probabilities of different strategies
}
