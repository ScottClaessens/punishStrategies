...
Answers to the self-rating sliders were related to strategy usage in predictable ways. In general, citing any reason to punish tended to be negatively related to usage of the anti-punish strategy. People citing egalitarian, harm-reduction, or disapproval-signalling motivations were more likely to follow egalitarian and/or norm enforcing strategies. In addition:

- people who wanted to _have a higher final bonus than others_ or _avoid having a lower final bonus than others_ were more likely to follow the antisocial strategy
- people who admitted that they _decided at random_ were more likely to follow the random choice strategy
- people who _punishing those who did NOT cause harm_ were less likely to follow the egalitarian strategy and more likely to follow the avoid DI and random choice strategies

```{r plotPredSelfRate, fig.width=7, fig.height=4, fig.align='center', out.width="100%"}
...
Personality was largely unrelated to strategy usage. The only slopes with 95% credible intervals that excluded zero were for extraversion and honesty-humility. Extraversion negatively predicted usage of the anti-punish strategy, while honesty-humility positively predicted usage of the anti-punish strategy.

```{r plotPredPersonality, fig.width=7, fig.height=4, fig.align='center', out.width="100%"}
...
We found that social value orientation angle positively predicted usage of the egalitarian and anti-punish strategies.
...
Political ideology was largely unrelated to strategy usage. Unidimensional political ideology was unrelated to all strategies, while SDO and RWA negatively predicted usage of the anti-punish strategy. Wanting to bring people up or down a peg on the SES ladder was also unrelated to strategy usage.

```{r plotPredPolIdeology, fig.width=7, fig.height=4, fig.align='center', out.width="100%"}
tar_read(plot2_PolSlider)
tar_read(plot2_SDO)
tar_read(plot2_RWA)
...
Both religiosity items were unrelated to strategy usage.

```{r plotPredReligion, fig.width=7, fig.height=4, fig.align='center', out.width="100%"}
